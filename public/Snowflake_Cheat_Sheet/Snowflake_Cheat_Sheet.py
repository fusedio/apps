...
st.sidebar.markdown(
    '''
    Direct Copy from [here](https://github.com/syasini/snowflake_cheatsheet/blob/main/app.py) by [Siavash Yasini](https://github.com/syasini)<a href="https://github.com/syasini"><img src="https://avatars.githubusercontent.com/u/47579697?v=4" width="20"></a>
    '''
