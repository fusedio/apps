...
def cs_sidebar():
    ...
    st.sidebar.markdown(
    '''
    Direct Copy from [here](https://github.com/daniellewisdl/streamlit-cheat-sheet/blob/master/app.py) by [Daniel Lewis](https://github.com/daniellewisDL) 
    <img src="https://avatars.githubusercontent.com/u/50626393?v=4" width="20"></a>
    '''
