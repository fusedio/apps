...
selected_year = st.selectbox("Select CDL 1st Year", [2012, 2016, 2020, 2024])
cdl_categories = {
    0: "Background",
    1: "Corn",
    2: "Cotton",
...
path_for_data = f's3://fused-users/fused/sina/_del3h11_file_idf3_v3f2/year={selected_year}/*'
